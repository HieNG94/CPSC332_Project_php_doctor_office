...
<center>
    ...
    $sql = "SELECT dv.lastName AS ln, dv.firstName AS fn, sv.specialityname AS sn
                    FROM doctorview AS dv
                    LEFT JOIN specview AS sv
                    ON dv.doctorId = sv.doctorId
                    ORDER BY dv.lastName, dv.firstName;";
    $num = 0;
...
<div class="footer" style="position: fixed; bottom: 35px; width:81.5%;">
    <button style="font-weight: bold; padding:10px; margin: 5px; width:150px" onclick="location.href='doctorspecialities.php'">SHOW LESS</button>

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['add'])) {
        if ($flag3 == true) {
            $query2 = "INSERT INTO pvisitpresciption (presciptionId, visitId)
                        VALUES ('" . $_POST["presciptionId"] . "','" . $_POST["visitId"] . "');";
...
<h2 style="padding-left: 50px;"><u>Add new patient presciption:</u></h2>
